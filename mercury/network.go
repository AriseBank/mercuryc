...
func (c *networkCmd) usage() string {
	return i18n.G(
		`Usage: mercury network <subcommand> [options]

Manage and attach containers to networks.

mercury network list [<remote>:]
    List available networks.

mercury network show [<remote>:]<network>
    Show details of a network.

mercury network create [<remote>:]<network> [key=value...]
    Create a network.

mercury network get [<remote>:]<network> <key>
    Get network configuration.

mercury network set [<remote>:]<network> <key> <value>
    Set network configuration.

mercury network unset [<remote>:]<network> <key>
    Unset network configuration.

mercury network delete [<remote>:]<network>
    Delete a network.

mercury network edit [<remote>:]<network>
    Edit network, either by launching external editor or reading STDIN.

mercury network attach [<remote>:]<network> <container> [device name] [interface name]
    Attach a network interface connecting the network to a specified container.

mercury network attach-profile [<remote>:]<network> <profile> [device name] [interface name]
    Attach a network interface connecting the network to a specified profile.

mercury network detach [<remote>:]<network> <container> [device name]
    Remove a network interface connecting the network to a specified container.

mercury network detach-profile [<remote>:]<network> <container> [device name]
    Remove a network interface connecting the network to a specified profile.

*Examples*
cat network.yaml | mercury network edit <network>
...
func (c *networkCmd) doNetworkAttach(client apollo.ContainerServer, name string, args []string) error {
...
func (c *networkCmd) doNetworkAttachProfile(client apollo.ContainerServer, name string, args []string) error {
	if len(args) < 1 || len(args) > 3 {
		return errArgs
	}
...
func (c *networkCmd) doNetworkCreate(client apollo.ContainerServer, name string, args []string) error {
...
func (c *networkCmd) doNetworkDetach(client apollo.ContainerServer, name string, args []string) error {
...
func (c *networkCmd) doNetworkDetachProfile(client apollo.ContainerServer, name string, args []string) error {
	if len(args) < 1 || len(args) > 2 {
		return errArgs
	}
...
func (c *networkCmd) doNetworkDelete(client apollo.ContainerServer, name string) error {
...
func (c *networkCmd) doNetworkEdit(client apollo.ContainerServer, name string) error {
...
func (c *networkCmd) doNetworkGet(client apollo.ContainerServer, name string, args []string) error {
...
func (c *networkCmd) doNetworkSet(client apollo.ContainerServer, name string, args []string) error {
...
func (c *networkCmd) doNetworkShow(client apollo.ContainerServer, name string) error {
	if name == "" {
		return errArgs
	}
