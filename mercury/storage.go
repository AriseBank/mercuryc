...
### config:
###   size: "61203283968"
###   source: /home/chb/mnt/apollo_test/default.img
...
func (c *storageCmd) usage() string {
	return i18n.G(
		`Usage: mercury storage <subcommand> [options]

Manage storage pools and volumes.

*Storage pools*
mercury storage list [<remote>:]
    List available storage pools.

mercury storage show [<remote>:]<pool>
    Show details of a storage pool.

mercury storage create [<remote>:]<pool> <driver> [key=value]...
    Create a storage pool.

mercury storage get [<remote>:]<pool> <key>
    Get storage pool configuration.

mercury storage set [<remote>:]<pool> <key> <value>
    Set storage pool configuration.

mercury storage unset [<remote>:]<pool> <key>
    Unset storage pool configuration.

mercury storage delete [<remote>:]<pool>
    Delete a storage pool.

mercury storage edit [<remote>:]<pool>
    Edit storage pool, either by launching external editor or reading STDIN.

*Storage volumes*
mercury storage volume list [<remote>:]<pool>
    List available storage volumes on a storage pool.

mercury storage volume show [<remote>:]<pool> <volume>
    Show details of a storage volume on a storage pool.

mercury storage volume create [<remote>:]<pool> <volume> [key=value]...
    Create a storage volume on a storage pool.

mercury storage volume get [<remote>:]<pool> <volume> <key>
...
mercury storage volume unset [<remote>:]<pool> <volume> <key>
    Unset storage volume configuration on a storage pool.

mercury storage volume delete [<remote>:]<pool> <volume>
    Delete a storage volume on a storage pool.

mercury storage volume edit [<remote>:]<pool> <volume>
    Edit storage pool, either by launching external editor or reading STDIN.

mercury storage volume attach [<remote>:]<pool> <volume> <container> [device name] <path>
    Attach a storage volume to the specified container.

mercury storage volume attach-profile [<remote:>]<pool> <volume> <profile> [device name] <path>
    Attach a storage volume to the specified profile.

mercury storage volume detach [<remote>:]<pool> <volume> <container> [device name]
    Detach a storage volume from the specified container.

mercury storage volume detach-profile [<remote:>]<pool> <volume> <profile> [device name]
...
*Examples*
cat pool.yaml | mercury storage edit [<remote>:]<pool>
    Update a storage pool using the content of pool.yaml.

cat pool.yaml | mercury storage volume edit [<remote>:]<pool> <volume>
    Update a storage volume using the content of pool.yaml.

mercury storage volume show default data
    Will show the properties of a custom volume called "data" in the "default" pool.

mercury storage volume show default container/data
...
func (c *storageCmd) doStoragePoolVolumeAttach(client apollo.ContainerServer, pool string, volume string, args []string) error {
...
func (c *storageCmd) doStoragePoolVolumeDetach(client apollo.ContainerServer, pool string, volume string, args []string) error {
...
func (c *storageCmd) doStoragePoolVolumeAttachProfile(client apollo.ContainerServer, pool string, volume string, args []string) error {
	if len(args) < 2 || len(args) > 3 {
		return errArgs
	}
...
func (c *storageCmd) doStoragePoolCreate(client apollo.ContainerServer, name string, driver string, args []string) error {
...
func (c *storageCmd) doStoragePoolVolumeDetachProfile(client apollo.ContainerServer, pool string, volume string, args []string) error {
	if len(args) < 1 || len(args) > 2 {
		return errArgs
	}
...
func (c *storageCmd) doStoragePoolDelete(client apollo.ContainerServer, name string) error {
...
func (c *storageCmd) doStoragePoolEdit(client apollo.ContainerServer, name string) error {
...
func (c *storageCmd) doStoragePoolGet(client apollo.ContainerServer, name string, args []string) error {
...
func (c *storageCmd) doStoragePoolSet(client apollo.ContainerServer, name string, args []string) error {
	if len(args) < 1 {
		return errArgs
	}
...
func (c *storageCmd) doStoragePoolShow(client apollo.ContainerServer, name string) error {
	if name == "" {
		return errArgs
	}
...
func (c *storageCmd) doStoragePoolVolumeCreate(client apollo.ContainerServer, pool string, volume string, args []string) error {
	// Parse the input
	volName, volType := c.parseVolume(volume)
...
func (c *storageCmd) doStoragePoolVolumeDelete(client apollo.ContainerServer, pool string, volume string) error {
	// Parse the input
	volName, volType := c.parseVolume(volume)
...
func (c *storageCmd) doStoragePoolVolumeGet(client apollo.ContainerServer, pool string, volume string, args []string) error {
	if len(args) != 2 {
		return errArgs
	}
...
func (c *storageCmd) doStoragePoolVolumeSet(client apollo.ContainerServer, pool string, volume string, args []string) error {
	if len(args) < 2 {
		return errArgs
	}
...
func (c *storageCmd) doStoragePoolVolumeShow(client apollo.ContainerServer, pool string, volume string) error {
	// Parse the input
	volName, volType := c.parseVolume(volume)
...
func (c *storageCmd) doStoragePoolVolumeEdit(client apollo.ContainerServer, pool string, volume string) error {
	// Parse the input
	volName, volType := c.parseVolume(volume)
