...
func (r *ProtocolAPOLLO) GetServer() (*api.Server, string, error) {
	server := api.Server{}
...
func (r *ProtocolAPOLLO) UpdateServer(server api.ServerPut, ETag string) error {
	// Send the request
...
func (r *ProtocolAPOLLO) HasExtension(extension string) bool {
