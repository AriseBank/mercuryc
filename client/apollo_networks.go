...
func (r *ProtocolAPOLLO) GetNetworkNames() ([]string, error) {
	urls := []string{}
...
func (r *ProtocolAPOLLO) GetNetworks() ([]api.Network, error) {
...
func (r *ProtocolAPOLLO) GetNetwork(name string) (*api.Network, string, error) {
	network := api.Network{}
...
func (r *ProtocolAPOLLO) CreateNetwork(network api.NetworksPost) error {
...
func (r *ProtocolAPOLLO) UpdateNetwork(name string, network api.NetworkPut, ETag string) error {
	// Send the request
...
func (r *ProtocolAPOLLO) RenameNetwork(name string, network api.NetworkPost) error {
	// Send the request
...
func (r *ProtocolAPOLLO) DeleteNetwork(name string) error {
	// Send the request
