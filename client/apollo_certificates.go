...
func (r *ProtocolAPOLLO) GetCertificateFingerprints() ([]string, error) {
	certificates := []string{}
...
func (r *ProtocolAPOLLO) GetCertificates() ([]api.Certificate, error) {
...
func (r *ProtocolAPOLLO) GetCertificate(fingerprint string) (*api.Certificate, string, error) {
...
// CreateCertificate adds a new certificate to the APOLLO trust store
func (r *ProtocolAPOLLO) CreateCertificate(certificate api.CertificatesPost) error {
	// Send the request
...
func (r *ProtocolAPOLLO) UpdateCertificate(fingerprint string, certificate api.CertificatePut, ETag string) error {
...
// DeleteCertificate removes a certificate from the APOLLO trust store
func (r *ProtocolAPOLLO) DeleteCertificate(fingerprint string) error {
	// Send the request
