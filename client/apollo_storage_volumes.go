...
func (r *ProtocolAPOLLO) GetStoragePoolVolumeNames(pool string) ([]string, error) {
...
func (r *ProtocolAPOLLO) GetStoragePoolVolumes(pool string) ([]api.StorageVolume, error) {
...
func (r *ProtocolAPOLLO) GetStoragePoolVolume(pool string, volType string, name string) (*api.StorageVolume, string, error) {
...
func (r *ProtocolAPOLLO) CreateStoragePoolVolume(pool string, volume api.StorageVolumesPost) error {
	// Send the request
...
func (r *ProtocolAPOLLO) UpdateStoragePoolVolume(pool string, volType string, name string, volume api.StorageVolumePut, ETag string) error {
	// Send the request
...
func (r *ProtocolAPOLLO) DeleteStoragePoolVolume(pool string, volType string, name string) error {
	// Send the request
