...
// NetworksPost represents the fields of a new APOLLO network
//
...
// NetworkPost represents the fields required to rename a APOLLO network
//
// API extension: network
...
// NetworkPut represents the modifiable fields of a APOLLO network
//
// API extension: network
...
// Network represents a APOLLO network
type Network struct {
	NetworkPut `yaml:",inline"`
