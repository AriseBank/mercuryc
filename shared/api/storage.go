...
// StoragePoolsPost represents the fields of a new APOLLO storage pool
//
...
// StoragePool represents the fields of a APOLLO storage pool.
//
// API extension: storage
...
// StoragePoolPut represents the modifiable fields of a APOLLO storage pool.
//
// API extension: storage
...
// StorageVolumesPost represents the fields of a new APOLLO storage pool volume
//
// API extension: storage
...
// StorageVolume represents the fields of a APOLLO storage volume.
//
// API extension: storage
...
// StorageVolumePut represents the modifiable fields of a APOLLO storage volume.
//
// API extension: storage
