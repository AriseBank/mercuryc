...
// ResponseRaw represents a APOLLO operation in its original form
...
// Response represents a APOLLO operation
...
// ResponseType represents a valid APOLLO response type
