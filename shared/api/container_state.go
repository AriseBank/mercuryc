...
// ContainerStatePut represents the modifiable fields of a APOLLO container's state
...
// ContainerState represents a APOLLO container's state
...
// ContainerStateDisk represents the disk information section of a APOLLO container's state
type ContainerStateDisk struct {
	Usage int64 `json:"usage" yaml:"usage"`
}

// ContainerStateCPU represents the cpu information section of a APOLLO container's state
//
// API extension: container_cpu_time
...
// ContainerStateMemory represents the memory information section of a APOLLO container's state
...
// ContainerStateNetwork represents the network information section of a APOLLO container's state
...
// ContainerStateNetworkAddress represents a network address as part of the network section of a APOLLO container's state
...
// ContainerStateNetworkCounters represents packet counters as part of the network section of a APOLLO container's state
